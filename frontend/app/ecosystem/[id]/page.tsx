...
import { ShieldCheck, MapPin, ExternalLink, Briefcase, Users } from "lucide-react";
...
export default function StartupProfilePage() {
  ...
  const startup = {
    ...
    stage: "Seed",
    funding: "₹12cr raised",
    about: "NexusAI is building the operating system for enterprise LLM applications. We help Fortune 500 companies securely orchestrate, evaluate, and deploy foundational models across their internal workflows without compromising data privacy. Our core infrastructure is built on Rust, providing 10x lower latency for concurrent inference pipelines.",
    team: [
      { name: "Rahul Sharma", role: "CEO & Co-founder", bio: "Ex-Google Brain researcher. Previously scaled two infrastructure startups to acquisition.", seed: "Rahul", linkedin: "#" },
      { name: "Sneha Reddy", role: "CTO & Co-founder", bio: "Led distributed systems at AWS. Creator of popular open-source orchestration tool.", seed: "Sneha", linkedin: "#" },
    ],
    roles: [
      { title: "Senior AI Engineer", type: "Full-time", location: "Bengaluru", remote: true },
      { title: "Frontend Developer (React/Three.js)", type: "Full-time", location: "Bengaluru", remote: false },
      { title: "Product Marketing Intern", type: "Internship", location: "Remote", remote: true },
    ]
  };
                      ...
                      {startup.team.map((founder, i) => (
                        ...
                        >
                          <div className="flex items-start justify-between">
                            ...
                            />
                            <a href={founder.linkedin} className="text-[#6b6b6b] hover:text-[#c8f135] transition-colors p-2">
          ...
          <div className="flex-[0_0_100%] lg:flex-[0_0_35%]">
            <div className="sticky top-[100px]">
              ...
              >
                ...
                <button 
                  className="w-full py-3 bg-transparent border border-white/10 text-[#e4e4e4] font-medium rounded-[8px] hover:bg-white/5 transition-colors"
                  style={{ fontFamily: "var(--font-inter), sans-serif", fontSize: "14px" }}
                >
                  Visit Website
                </button>
